...
public class SalesPerCarsBrand {
    ...
    public static final void main(String args[]) throws Exception {
        ...
        PCollection<String> input =
                pipeline.apply(TextIO.read().from("/tmp/beam/cars_sales_log.txt"));
        ...
        sumUpValuesByKey.apply(TextIO.write().to("./tmp/beam/cars_sales_report.txt").withoutSharding());
